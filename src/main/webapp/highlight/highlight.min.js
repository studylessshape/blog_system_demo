...
strings:i,keywords:u}}}})());hljs.registerLanguage("lisp",(()=>{"use strict";return e=>{
...
contains:[l,e.SHEBANG(),s,b,g,o,v,m,c]}}})());hljs.registerLanguage("powershell",(()=>{"use strict";return e=>{const n={
$pattern:/-?[A-z\.\-]+\b/,
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}})());hljs.registerLanguage("markdown",(()=>{"use strict";function n(...n){
...
begin:'""'}],starts:a
},e.COMMENT("^\\s*%\\{\\s*$","^\\s*%\\}\\s*$"),e.COMMENT("%","$")]}}})());hljs.registerLanguage("cmake",(()=>{"use strict";return e=>({name:"CMake",
...
className:"meta",begin:"#",end:"$"}]})})());hljs.registerLanguage("dart",(()=>{"use strict";return e=>{const n={
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("python",(()=>{"use strict";function e(e){
